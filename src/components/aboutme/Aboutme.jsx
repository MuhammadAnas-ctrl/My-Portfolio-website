        ...
        <div className="right">
          ...
          <div className="bottom">
            <p>
              ...
              <span className="pspan">ReactJS</span> along with <span className="pspan">ExpressJs</span> ,{" "}
              <span className="pspan">NodeJs</span>, and{" "}
              <span className="pspan">Python</span>. I excel in designing and
